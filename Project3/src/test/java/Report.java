...
public class Report {
    ...
    private static String testName = "BuyMe Mobile Application Sanity Test";
    private static String testDescription = "Tests the basic functionality of BuyMe application.";
    ...
    private static String environmentActual = "Samsung Galaxy S8";
    ...
    //takeScreenshot takes screenshot with current time, using takeScreenShot function
    ...
    private static String takeScreenShot(String ImagesPath) {
        TakesScreenshot takesScreenshot = (TakesScreenshot) DriverInitiation.driver;
